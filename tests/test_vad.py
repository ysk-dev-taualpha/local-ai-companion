"""Silero VAD unit tests with mocked ONNX inference."""
...
class TestSileroVAD(unittest.TestCase):
    def setUp(self):
        ...
        self.vad._speech_start_time = 0.0
        self.vad._silence_start_time = None
        self.vad._leftover = []
    ...
    def test_speech_end(self):
        ...
        self._mock.set_prob(0.9)
        self.vad.process_chunk(self._pcm(512))
        self.vad._speech_start_time = time.time() - 0.6
        self._mock.set_prob(0.1)
        self.vad._silence_start_time = time.time() - 0.35
        r = self.vad.process_chunk(self._pcm(512))
    ...
    def test_short_speech_ignored(self):
        ...
        self._mock.set_prob(0.9)
        self.vad.process_chunk(self._pcm(512))
        self.vad._speech_start_time = time.time() - 0.2
        self._mock.set_prob(0.1)
        self.vad._silence_start_time = time.time() - 0.35
        r = self.vad.process_chunk(self._pcm(512))
        self.assertEqual(r["event"], "idle")
